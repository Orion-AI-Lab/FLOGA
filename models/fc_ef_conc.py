'''
Code adapted from https://rcdaudt.github.io/

Daudt et al. "Fully convolutional siamese networks for change detection". In 2018 25th IEEE International Conference on Image Processing (ICIP) (pp. 4063-4067). IEEE.
'''
...
class FC_EF_conc(nn.Module):
    def __init__(self, input_nbr, label_nbr, return_feats=False):
        super(FC_EF_conc, self).__init__()
    ...
    def forward(self, x1, x2):
        ...
        if self.return_feats:
            return x4p_1, x4p_2, self.sm(x11d)
